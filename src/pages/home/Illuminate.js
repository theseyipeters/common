	...
	return (
		<section className="h-fit py-[50px] bg-white-2 px-[20px] md:px-[50px] lg:px-[150px] font-outfit">
			<div className="flex flex-col md:flex-col lg:flex-row w-full gap-x-5 gap-y-10 items-center justify-between">
				<aside className="w-full lg:w-1/2 flex flex-col items-center lg:items-start gap-3 text-center lg:text-left">
					...
					<div className="w-full lg:w-full flex flex-col lg:flex-row items-center justify-center  gap-4">
						<Button
							variant={"outlined"}
							state="default"
							className={`w-full lg:w-48 lg:max-w-full h-auto`}
							size={"lg"}>
							Explore
						</Button>
